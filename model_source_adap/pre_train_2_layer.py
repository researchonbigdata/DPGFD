...
from model_source_adap.utils import accuracy
...
def pre_train2(cuda, dataset, hidden, adj, oneweek, twoweek, threeweek, month, id_feature, labels, idx_train, idx_val, gamma):
    stop_count = 0
    val_loss_final = 0
    last_loss = 1000
